...
# Do these global version of the algorithms reveal similar structure in the projection space or not?
## I think they are quite different in terms of their global patterns.

# Give just a couple sentences describing your thoughts on global vs. local behavior, 
## As for the t-sne algorithm, 
## setting the value to 1000 gives me a more global version of graph, while smaller values bring a more local version.
## As we can see from the graph, the density of dots is very high and it's really hard to examine the local behaviors even if 
## I zoom in.
## But we should note that the overlap always exists.

## AS for the UMAP algorithm,
## setting the value to 1000 helps me include more neighbors in the fuzzy search region.
## First, in the setting of epochs = 20:
## Comparing with smaller number of neighborhoods, the graph is becoming sparser. I think it starts to 
## capture more local information or behaviors 
## Second, in the setting of epochs = 500:
## Comparing with smaller number of neighborhoods, the graph is becoming denser I think it starts to 
## capture more global information or behaviors 

# and also in comparing the t-SNE and UMAP algorithms. 

## Same as t-SNE, UMAP is also interested in proceeding locally to learn the structure 
## in the original high dimensional space and then project it in a lower 
## dimensional subspace

## However, a key diﬀerence between UMAP and t-SNE is the ability to 
## reproduce a projection solution

## This is possible with UMAP (making it also usually more accurate), 
## because while t-SNE is interested in assuming similarities equate 
## to probabilities in the lower dimensional projection, UMAP avoids 
## the notion of probabilistic similarities altogether